...
&\frac{\partial}{\partial \mu} \left( -\frac{n}{2} \log \left( 2 \pi \sigma^2 \right) - \frac{1}{2 \sigma^2} \sum_{i=1}^n (x_i - \mu)^2 \right) = \\
&\frac{\partial}{\partial \mu} \left( -\frac{n}{2} \log \left( 2 \pi \sigma^2 \right) - \frac{1}{2 \sigma^2} \sum_{i=1}^n (x_i^2 - 2 x_i \mu + \mu^2) \right) = \\
&\frac{\partial}{\partial \mu} \left( -\frac{n}{2} \log \left( 2 \pi \sigma^2 \right) - \frac{1}{2 \sigma^2} \left( \sum_{i=1}^n x_i^2 - 2 \sum_{i=1}^n x_i \mu + \sum_{i=1}^n \mu^2 \right) \right) = \\
&\frac{\partial}{\partial \mu} \left( -\frac{n}{2} \log \left( 2 \pi \sigma^2 \right) - \frac{1}{2 \sigma^2} \left( \sum_{i=1}^n x_i^2 - 2 n \mu \bar{x} + n \mu^2 \right) \right) = \\
\end{align*}
$$
...
&\frac{\partial \ell(\mu, \sigma | x)}{\partial \mu} = \\
&\frac{\partial}{\partial \mu} \left( -\frac{n}{2} \log \left( 2 \pi \sigma^2 \right) - \frac{1}{2 \sigma^2} \left( \sum_{i=1}^n x_i^2 - 2 n \mu \bar{x} + n \mu^2 \right) \right) = \\
&\frac{\partial}{\partial \mu} \left( - \frac{1}{2 \sigma^2} \left(- 2 n \mu \bar{x} + n \mu^2 \right) \right) = \\
&\frac{\partial}{\partial \mu} \left( \frac{n \mu^2}{2 \sigma^2} - \frac{n \mu \bar{x}}{\sigma^2} \right) = \\
...
\hline
\text{Binomial} & \text{Logit} = \log \left( \frac{p}{1 - p} \right) & (0, 1) \\
\hline
...
# Graficamos la distribución logística
library(ggplot2)
library(ggdark)
...
<center>
![](img/sad_science.jpg){width="100%" height="550px"}
</center>